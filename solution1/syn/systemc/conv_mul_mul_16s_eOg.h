...
// ==============================================================
#ifndef __conv_mul_mul_16s_eOg__HH__
#define __conv_mul_mul_16s_eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_mul_16s_eOg) {
    ...
    SC_CTOR(conv_mul_mul_16s_eOg):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
