...
// ==============================================================
#ifndef __conv_mul_mul_5ns_fYi__HH__
#define __conv_mul_mul_5ns_fYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_mul_5ns_fYi) {
    ...
    SC_CTOR(conv_mul_mul_5ns_fYi):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
