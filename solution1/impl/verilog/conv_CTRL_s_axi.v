...
localparam
    ...
    ADDR_IN1_V_CTRL      = 6'h14,
    ADDR_IN2_V_DATA_0    = 6'h18,
    ADDR_IN2_V_CTRL      = 6'h1c,
    ADDR_IN3_V_DATA_0    = 6'h20,
    ADDR_IN3_V_CTRL      = 6'h24,
    ADDR_WEIGHT_V_DATA_0 = 6'h28,
    ADDR_WEIGHT_V_CTRL   = 6'h2c,
    ADDR_BIAS_V_DATA_0   = 6'h30,
    ADDR_BIAS_V_CTRL     = 6'h34,
    ADDR_OUT_V_DATA_0    = 6'h38,
    ADDR_OUT_V_CTRL      = 6'h3c,
    WRIDLE               = 2'd0,
    WRDATA               = 2'd1,
    WRRESP               = 2'd2,
    WRRESET              = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_WEIGHT_V_DATA_0: begin
                    rdata <= int_weight_V[31:0];
                end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_WEIGHT_V_DATA_0)
            int_weight_V[31:0] <= (WDATA[31:0] & wmask) | (int_weight_V[31:0] & ~wmask);
    end
end
